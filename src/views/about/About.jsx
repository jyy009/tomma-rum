      ...
      <div className="sm:flex justify-between ">
        ...
        <aside className=" flex flex-col items-center">
          ...
          <img
            ...
            className="w-[300px] sm:w-[400px] aspect-4/3 mb-[10px]"
          />
        </aside>
      </div>
    </main>
